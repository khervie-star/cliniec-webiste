...
export default function EasyClinicHero() {
    return (
        <section className="relative min-h-[80vh] md:min-h-[700px] flex items-center bg-gradient-to-r from-gray-900/90 to-gray-900/70">
            {/* Background Image */}
            ...
            {/* Content */}
            <div className="relative z-10 w-[90%] mx-auto py-28 md:py-40">
                <div className="max-w-6xl">
                    <h1 className="font-poppins font-semibold text-4xl md:text-5xl lg:text-6xl text-white leading-[60px] md:leading-[60px] lg:leading-[80px] xl:leading-[80px] mb-6">
                        Consolidated Healthcare Services for Patient Best and Easy Experience
                    </h1>
                    <p className="font-poppins text-lg md:text-xl text-gray-200 mb-10 leading-[1.8] md:leading-[1.9] max-w-4xl">
